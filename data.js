window.MARKET_DATA_SAMPLE = {
  ...
  source: {
    ...
    mode: "sample",
    note: "Static fallback used when live data is unavailable",
  },
  freshness: {
    fx: "sample",
    indices: "sample",
  ...
  newsItems: [
    {
      title: "Fed signal keeps traders cautious",
      summary: "정책 경계가 유지되며 금리 민감 자산에 부담이 남습니다.",
      impact: "채권, 달러",
      importance: "high",
    ...
    {
      title: "Oil prices firm on supply concerns",
      summary: "에너지 가격 강세가 인플레이션 기대를 자극합니다.",
      impact: "원자재",
      importance: "mid",
      link: "https://finance.yahoo.com/",
      published: "sample",
    ...
    {
      title: "Tech stocks face valuation pressure",
      summary: "장기금리 상승이 성장주 멀티플을 누르는 상황입니다.",
      impact: "지수, 성장주",
      importance: "high",
      link: "https://finance.yahoo.com/",
      published: "sample",
    ...
    {
      title: "FX market watches dollar strength",
      summary: "달러 강세가 신흥국 통화와 원화 방향을 좌우합니다.",
      impact: "환율",
      importance: "mid",
      link: "https://finance.yahoo.com/",
      published: "sample",
